// link tham khao :http://arduino.vn/bai-viet/565-tao-mot-quy-trinh-cong-nghiep-voi-cac-buoc-bang-arduino
...
void setup()
{
	...
	//print ra nhanh hơn
	printToSerial100msScheduler = new WorkScheduler(500UL, printToSerial100ms);
